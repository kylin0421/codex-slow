...
Write-Output '  2. In a new session, type $slow and send to turn slow mode on, $slow 10 for ten'
Write-Output '     seconds, $slow off to stop. Codex skills are $ mentions, not slash commands.'
